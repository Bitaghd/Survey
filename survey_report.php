...
<div class="col-lg-12">
	<div class="d-flex w-100 justify-content-center align-items-center mb-2">
		...
		<div class="input-group input-group-sm col-sm-5">
          <input type="text" class="form-control" id="filter" placeholder="Введите ключевое слово...">
              ...
              <div class="card-body" style="display: block;">
               ...
               <div class="row">
               	...
               	<div class="d-flex justify-content-center w-100 text-center">
               			<a href="index.php?page=view_survey_report&id=<?php echo $row['id'] ?>" >Подробнее</a>
               	</div>
               </div>
              </div>
            </div>

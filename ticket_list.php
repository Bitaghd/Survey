			...
			<table class="table table-hover table-bordered" id="list">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php if($row['status'] == 0): ?>
								<span class="badge badge-primary">Ожидание/открыт</span>
							<?php elseif($row['status'] == 1): ?>
								<span class="badge badge-Info">Обработка</span>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      <a class="dropdown-item view_ticket" href="./index.php?page=view_ticket&id=<?php echo $row['id'] ?>" data-id="<?php echo $row['id'] ?>">Просмотреть</a>
		                      <div class="dropdown-divider"></div>
		                      <a class="dropdown-item" href="./index.php?page=edit_ticket&id=<?php echo $row['id'] ?>">Редактировать</a>
		                      <div class="dropdown-divider"></div>
		                      <a class="dropdown-item delete_ticket" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Удалить</a>
		                    </div>
						</td>
					</tr>	
				<?php endwhile; ?>
...
<script>
	...
	_conf("Вы уверены, что хотите удалить эту карточку?","delete_ticket",[$(this).attr('data-id')])
	})
	})

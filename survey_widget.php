...
<div class="col-lg-12">
	<!-- <div class="d-flex w-100 justify-content-center align-items-center mb-2">
		<label for="" class="control-label">Найти опрос</label>
		<div class="input-group input-group-sm col-sm-5">
          <input type="text" class="form-control" id="filter" placeholder="Enter keyword...">
          <span class="input-group-append">
            <button type="button" class="btn btn-primary btn-flat" id="search">Поиск</button>
          </span>
        </div>
	</div>
	<div class=" w-100" id='ns' style="display: none"><center><b>Нет результатов.</b></center></div>
	<div class="row"> -->
		<?php 
               ...
               <div class="row">
               	...
               	<div class="d-flex justify-content-center w-100 text-center">
               		<?php if(!isset($ans[$row['id']])): ?>
               			<a href="index.php?page=answer_survey&id=<?php echo $row['id'] ?>" class="btn btn-sm bg-gradient-primary"><i class="fa fa-pen-square"></i> Пройти опрос</a>
               		<?php else: ?>
               			<p class="text-primary border-top ">Готово</p>
               		<?php endif; ?>
               	</div>
               </div>
              </div>

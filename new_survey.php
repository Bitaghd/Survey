		...
		<div class="">
			<form action="" id="manage_survey">
				...
				<div class="  justify-content-center d-flex">
					...
					<button class="btn btn-default" type="button" onclick="location.href = 'index.php?page=survey_list'">Отмена</button>
				</div>
			</form>
		</div>
	</div>

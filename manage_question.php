			...
			<div class="row">
				<div class="col-sm-6 border-right">
						...
						<div class="form-group">
							...
							<textarea name="question" id="" cols="10" rows="1" class="form-control"><?php echo isset($question)? $question: '' ?></textarea>
						</div>
						<div class="form-group">
							<label for="" class="control-label">Тип ответа на вопрос</label>
							<select name="type" id="type" class="custom-select custom-select-sm">
								<?php if(isset($id)): ?>
								<option value="" disabled="" selected="">Пожалуйста выберите здесь</option>
								<?php endif; ?>
								<option value="radio_opt" <?php echo isset($type) && $type == 'radio_opt' ? 'selected':'' ?>>Один ответ</option>
								<option value="check_opt" <?php echo isset($type) && $type == 'check_opt' ? 'selected':'' ?>>Множественный ответ</option>
								<option value="textfield_s" <?php echo isset($type) && $type == 'textfield_s' ? 'selected':'' ?>>Текстовое поле</option>
							</select>
						</div>
				...
				<div class="col-sm-6">
					...
					<div class="preview">
						<?php if(!isset($id)): ?>
						<center><b>Сначала выберите тип ответа на вопрос.</b></center>
						<?php else: ?>
						      	...
						      	<thead>
							      	<tr class="">
								      	...
								      	<th class="text-center">
								      		<label for="" class="control-label">Метка</label>
								      	</th>
								      	<th class="text-center"></th>
							     	</tr>
						     	</thead>
						...
						<?php else: ?>
								<textarea name="frm_opt" id="" cols="30" rows="10" class="form-control" disabled="" placeholder="Напишите здесь что-нибудь..."></textarea>
						<?php endif; ?>
						<?php endif; ?>
					</div>
				</div>
...
<div id="check_opt_clone"  style="display: none">
	<div class="callout callout-info">
      ...
      <div class="row">
      <div class="col-sm-12 text-center">
      	<button class="btn btn-sm btn-flat btn-default" type="button" onclick="new_check($(this))">Добавить</button>
      </div>
      </div>
    </div>
</div>
<div id="radio_opt_clone" style="display: none">
	<div class="callout callout-info">
      ...
      <div class="row">
      <div class="col-sm-12 text-center">
      	<button class="btn btn-sm btn-flat btn-default" type="button" onclick="new_radio($(this))">Добавить</button>
      </div>
      </div>
    </div>
</div>

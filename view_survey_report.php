			...
			<div class="card card-outline">
				...
				<div class="card-body ">
					<div class="container-fluid">
						...
						<p>Пройдено: <b><?php echo number_format($taken) ?></b></p>
			...
			<div class="card card-outline ">
				<div class="card-header">
					...
					<!-- <div class="card-tools">
						<button class="btn btn-flat btn-sm bg-gradient-success" type="button" id="print"><i class="fa fa-print"></i> Напечатать</button>
					</div> -->
				</div>
				<div class="card-body">
					<?php 
						...
						<input type="hidden" name="type[<?php echo $row['id'] ?>]" value="<?php echo $row['type'] ?>">	
							...
							<?php foreach(json_decode($row['frm_option']) as $k => $v): 
								...
								<li>
									...
									<div class=" col-sm-8">
									<div class="progress " >
					                  <div class="progress-bar " role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $prog ?>%">
